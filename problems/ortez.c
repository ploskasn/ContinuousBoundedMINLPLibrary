...
int main(int argc, char** argv) { 
   char *problemname="ortez";
   char input[30]="input.txt"; 
   char output[30]="output.txt"; 
   float x22,x23,x24,x25,x26,x27,x28,x29,x30,x31,x32,x33,x34,x35,x36,x37,x38,x39,x67,x68,x69,x70,x71,x72,x73,x74,x75,x76,x77,x78,x79,x80,x81,x82,x83,x84;
   float res;
   int i;
   FILE *fp;
   ...
   fclose(fp);
   res=- 300.544*x22 - 225.408*x23 - 150.272*x24 - 300.544*x25 - 225.408*x26
